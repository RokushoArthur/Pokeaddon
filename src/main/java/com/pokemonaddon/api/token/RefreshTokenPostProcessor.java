package com.pokemonaddon.api.token;
...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken>{
	...
	@Autowired
	private PokemonAddonApiProperty pokemonAddonProperty;
	...
	private void addRefreshTokenOnCookie(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
		...
		refreshTokenCookie.setSecure(pokemonAddonProperty.getSecurity().isEnableHttps());
